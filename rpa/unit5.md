...
Orchestrator users can also view and manage the execution history of schedules and triggers, including when they ran, if they succeeded or failed, and access logs for troubleshooting. 
